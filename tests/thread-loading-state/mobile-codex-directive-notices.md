...
13. Verify code-comment notices show `file`, `file:start`, and `file:start-end` for their respective location forms.
14. Copy/export the conversation and confirm typed, generic, and warning cards become readable Markdown containing no standalone raw directive syntax.
15. Repeat at 375×812 and 768×1024 in light and dark appearance; long names and values must wrap without horizontal page overflow.
